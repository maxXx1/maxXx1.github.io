...
Problém se týká zejména lednových aktualizací [KB5034440](https://support.microsoft.com/en-us/topic/kb5034440-windows-recovery-environment-update-for-windows-11-version-21h2-january-9-2024-1e07724a-3547-40f5-99ff-862cc48fd523) pro Windows 11 a [KB5034441](https://support.microsoft.com/en-us/topic/kb5034441-windows-recovery-environment-update-for-windows-10-version-21h2-and-22h2-january-9-2024-62c04204-aaa5-4fee-a02a-2fdea17075a8) pro Windows 10, které opravují chybu [CVE-2024-20666](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-20666).

Tato chyba umožňuje bypass Bitlockeru, právě přes oddíl obnovení (WinRE). Pro zneužití této chyby by byl nutný fyzický přístup k disku a ani tak se mi nepodařilo dohledat více detailů. Micrososft tedy chybu opravil, ale na staších instalacích OS se aktualizace nenainstaluje právě z důvodu chybějícího místa v rcovery oddílu a ve widndows update zůstane tato chyba viset s chybou `0x80070643`. Což vás může srát, takže můžete:
...
- Potvrdit `y`
- Spustiťte vámi uložený script vč. následujích parametrů

```powershell
.\Resize_script.ps1 -SkipConfirmation $true -BackupFolder c:\winre_backup
```

- Po dokončení nastavte restrikce zpět na původní hodnotu
