...
<figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="674" height="775" src="http://192.168.20.2/wordpress/wp-content/uploads/2020/09/crystal.png" alt="" class="wp-image-4294" srcset=" __GHOST_URL__ /content/images/wordpress/2020/09/crystal.png 674w, __GHOST_URL__ /content/images/wordpress/2020/09/crystal-261x300.png 261w" sizes="(max-width: 674px) 100vw, 674px"></figure>
...
<figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="566" height="459" src="http://192.168.20.2/wordpress/wp-content/uploads/2020/09/hdtune.png" alt="" class="wp-image-4296" srcset=" __GHOST_URL__ /content/images/wordpress/2020/09/hdtune.png 566w, __GHOST_URL__ /content/images/wordpress/2020/09/hdtune-300x243.png 300w" sizes="(max-width: 566px) 100vw, 566px"></figure>
...
<figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="566" height="459" src="http://192.168.20.2/wordpress/wp-content/uploads/2020/09/hdtune2.png" alt="" class="wp-image-4297" srcset=" __GHOST_URL__ /content/images/wordpress/2020/09/hdtune2.png 566w, __GHOST_URL__ /content/images/wordpress/2020/09/hdtune2-300x243.png 300w" sizes="(max-width: 566px) 100vw, 566px"></figure>
...
<figure class="wp-block-image size-large"><img decoding="async" loading="lazy" width="566" height="459" src="http://192.168.20.2/wordpress/wp-content/uploads/2020/09/hdtune3.png" alt="" class="wp-image-4298" srcset=" __GHOST_URL__ /content/images/wordpress/2020/09/hdtune3.png 566w, __GHOST_URL__ /content/images/wordpress/2020/09/hdtune3-300x243.png 300w" sizes="(max-width: 566px) 100vw, 566px"></figure>
